...
var CommandPalette = /** @class */ (function (_super) {
    ...
    CommandPalette.prototype.onUpdateRequest = function (msg) {
        ...
        if (!results) {
            ...
            this._activeIndex = (query ? ArrayExt.findFirstIndex(results, Private$9.canActivate) : -1);
        }
    ...
    CommandPalette.prototype._activateNextItem = function () {
        ...
        this._activeIndex = ArrayExt.findFirstIndex(this._results, Private$9.canActivate, start, stop);
    ...
    CommandPalette.prototype._activatePreviousItem = function () {
        ...
        this._activeIndex = ArrayExt.findLastIndex(this._results, Private$9.canActivate, start, stop);
        // Schedule an update of the items.
        this.update();
    };
    /**
...
var Menu = /** @class */ (function (_super) {
    ...
    Menu.prototype.activateNextItem = function () {
        ...
        var start = ai < n - 1 ? ai + 1 : 0;
        var stop = start === 0 ? n - 1 : start - 1;
        this.activeIndex = ArrayExt.findFirstIndex(this._items, Private$a.canActivate, start, stop);
    };
    /**
    ...
    Menu.prototype.activatePreviousItem = function () {
        ...
        var start = ai <= 0 ? n - 1 : ai - 1;
        var stop = start === n - 1 ? 0 : start + 1;
        this.activeIndex = ArrayExt.findLastIndex(this._items, Private$a.canActivate, start, stop);
    };
    /**
...
var DockLayout = /** @class */ (function (_super) {
    ...
    DockLayout.prototype._insertSplit = function (widget, ref, refNode, orientation, after) {
        ...
        if (splitNode.orientation === orientation) {
            ...
            ArrayExt.insert(splitNode.sizers, j_1, Private$d.createSizer(s));
        ...
        ArrayExt.insert(childNode.sizers, j, Private$d.createSizer(0.5));
...
var DockPanel = /** @class */ (function (_super) {
    ...
    Object.defineProperty(DockPanel.prototype, "mode", {
        ...
        set: function (value) {
            ...
            MessageLoop.postMessage(this, Private$e.LayoutModified);
        },
        enumerable: true,
        configurable: true
    });
